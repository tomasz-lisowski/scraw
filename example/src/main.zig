...
pub fn main() !void {
    ...
    var rapdu = try scraw.cardTransceive(capdu0[0..], rapdu_buffer[0..]);
    std.log.info("CAPDU={X} RAPDU={X}.", .{ capdu0[0..], rapdu[0..] });

    var capdu1 = [_]u8{ 0x00, 0xC0, 0x00, 0x00, rapdu[1] };
    rapdu = try scraw.cardTransceive(capdu1[0..], rapdu_buffer[0..]);
    std.log.info("CAPDU={X} RAPDU={X}.", .{ capdu1[0..], rapdu[0..] });
}
